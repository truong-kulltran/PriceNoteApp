...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.Wallet) {
      return _i7.Wallet.fromJson(data) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Wallet') {
      return deserialize<_i7.Wallet>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'learn_dart_serverpod';
}
